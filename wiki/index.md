...
| [子任务的输入输出与完成条件约定](ai-agent/subtask-contracts.md) | 重点：Codex 的结构化约定（InterAgentCommunication、CollabAgentState、SubAgentSource 的 JSON）；Crush/Claude Code 无严格约定一笔带过 | 2026-09-20 |
