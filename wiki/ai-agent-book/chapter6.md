...
![图6-1 事件驱动的异步 Agent 架构](../images/ai-agent-book/fig6-1.svg)
...
![图6-2 异步事件处理的三种策略](../images/ai-agent-book/fig6-2.svg)
...
>
>
> ![图6-3 实验 6-1 事件驱动 Agent 架构](../images/ai-agent-book/fig6-3.svg)
>
>
...
>
>
> ![图6-4 实验 6-2 异步 Agent 打断与恢复](../images/ai-agent-book/fig6-4.svg)
>
>
...
![图6-5 同步接口兼容与模型原生异步](../images/ai-agent-book/fig6-5.svg)
...
![图6-6 语音 Agent 串行流水线](../images/ai-agent-book/fig6-6.svg)
...
![图6-7 延迟瀑布：串行累积总响应时间](../images/ai-agent-book/fig6-7.svg)


生产环境的排队还会进一步放大空载延迟（图6-8），但这属于服务容量规划，本章不展开排队模型。


![图6-8 排队延迟曲线](../images/ai-agent-book/fig6-8.svg)
...
![图6-9 端到端多模态语音模型架构对比](../images/ai-agent-book/fig6-9.svg)
...
![图6-10 快/慢思考架构与方案对比](../images/ai-agent-book/fig6-10.svg)
...
![图6-11 Computer Use Agent 的感知-思考-行动循环](../images/ai-agent-book/fig6-11.svg)
...
![图6-12 Computer Use 动作空间](../images/ai-agent-book/fig6-12.svg)
...
![图6-13 Set-of-Mark 与结构化元素索引（browser-use 实现）](../images/ai-agent-book/fig6-13.svg)
...
![图6-14 分辨率匹配与双向坐标缩放](../images/ai-agent-book/fig6-14.svg)
