...
![图9-1 Agent 持续进化的总体闭环](../images/ai-agent-book/fig9-1.svg)
...
![图9-2 从环境结果到 LLM Rubric 的三层轨迹验证](../images/ai-agent-book/fig9-2.svg)
...
![图9-3 持续进化的四种更新方式](../images/ai-agent-book/fig9-3.svg)
...
![图9-4 从已评价轨迹到经验知识文档](../images/ai-agent-book/fig9-4.svg)
...
![图9-5 在线执行与离线进化的双循环](../images/ai-agent-book/fig9-5.svg)
