...
![图1-1 Agent 与 Environment 的闭环交互，以及 Agent 内部的 Model–Harness 结构](../images/ai-agent-book/fig1-1.svg)
...
![图1-2 Agent 能力更新的三个层次](../images/ai-agent-book/fig1-2.svg)
...
>
> ![图1-3 实验 1-1——上下文消融实验设计](../images/ai-agent-book/fig1-3.svg)
>
...
![图1-4 Agent 轨迹——多币种汇总任务的 ReAct 循环](../images/ai-agent-book/fig1-4.svg)
...
>
> ![图1-5 “模型即 Agent” 架构——原生工具调用](../images/ai-agent-book/fig1-5.svg)
...
![图1-6 自主 Agent 的执行循环](../images/ai-agent-book/fig1-6.svg)
...
![图1-7 n8n 工作流编辑器界面](../images/ai-agent-book/n8n-workflow.png)
