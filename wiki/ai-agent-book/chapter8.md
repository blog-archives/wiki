...
![图8-1 强化学习 Agent-环境交互循环](../images/ai-agent-book/fig8-1.svg)
...
![图8-2 马尔可夫决策过程（MDP）示意图](../images/ai-agent-book/fig8-2.svg)
...
![图8-3 Q-learning 网格世界](../images/ai-agent-book/fig8-3.svg)

![图8-4 Q 值更新可视化](../images/ai-agent-book/fig8-4.svg)
...
![图8-5 经典 RL 与现代 LLM Agent 对比](../images/ai-agent-book/fig8-5.svg)
...
![图8-6 OpenAI 训练范式演进](../images/ai-agent-book/fig8-6.svg)
...
>
>
> ![图8-7 Q-learning 与 LLM Agent 在寻宝游戏中的架构对比](../images/ai-agent-book/fig8-7.svg)
>
>
...
![图8-8 预训练的下一个 Token 预测](../images/ai-agent-book/fig8-8.svg)
...
>
>
> ![图8-9 视觉语言模型（VLM）架构](../images/ai-agent-book/fig8-9.svg)
>
>
...
![图8-10 监督微调（SFT）流水线](../images/ai-agent-book/fig8-10.svg)
...
![图8-11 SFT→RL 两阶段训练流程；Mid-training 位于这两个行为对齐阶段之前](../images/ai-agent-book/fig8-11.svg)
...
>
>
> ![图8-12 GeneralPoints 实验架构（GP-L 与 GP-VL 两个变体的训练与测试设计）](../images/ai-agent-book/fig8-12.svg)
>
>
...
![图8-13 同一 SWE-bench 任务的 16 次 rollout、验证与相对优势](../images/ai-agent-book/fig8-13.svg)
...
![图8-14 单轮 RL 与多轮 RL 对比](../images/ai-agent-book/fig8-14.svg)

![图8-15 多轮交互中的信用分配](../images/ai-agent-book/fig8-15.svg)
...
![图8-16 工具调用 RL 奖励循环](../images/ai-agent-book/fig8-16.svg)
...
>
> ![图8-17 ReTool 交织文本-代码思考与沙盒执行反馈循环](../images/ai-agent-book/fig8-17.svg)
>
...
>
> ![图8-18 AWorld-train MCP 沙盒训练架构与工具生态](../images/ai-agent-book/fig8-18.svg)
>
