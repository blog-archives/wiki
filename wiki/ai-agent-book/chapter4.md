...
![图4-1 MCP 协议交互时序](../images/ai-agent-book/fig4-1.svg)
...
![图4-2 层次化工具匹配（服务器级→工具级两层语义搜索）](../images/ai-agent-book/fig4-2.svg)
...
![图4-3 工具动态加载的 KV Cache 优化](../images/ai-agent-book/fig4-3.svg)
...
![图4-4 动态发现后的上下文结构：工具 schema 散落在轨迹各处](../images/ai-agent-book/fig4-4.svg)
