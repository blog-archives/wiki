...
![图2-1 上下文窗口的构成概览](../images/ai-agent-book/fig2-1.svg)
...
![图2-2 单轮 API 调用的请求与响应结构](../images/ai-agent-book/fig2-2.svg)
...
![图2-3 两次模型 API 调用的完整交互序列](../images/ai-agent-book/fig2-3.svg)
...
![图2-4 Agent 每次调用模型时的上下文构成](../images/ai-agent-book/fig2-4.svg)
...
>
>
> ![图2-5 本地 LLM 工具调用架构](../images/ai-agent-book/fig2-5.svg)
>
...
>
>
> ![图2-6 注意力机制的直观理解](../images/ai-agent-book/fig2-6.svg)
>
>
...
>
>
> ![图2-7 注意力热力图可视化](../images/ai-agent-book/fig2-7.png)
>
>
> 注意力热力图揭示了几个关键模式：
>
...
![图2-8 Chat Template 的 Token 结构](../images/ai-agent-book/fig2-8.svg)
...
![图2-9 API 消息到模型 Token 流的转换](../images/ai-agent-book/fig2-9.svg)
...
![图2-10 Prompt Cache：跨请求复用前缀的 KV Cache](../images/ai-agent-book/fig2-10.svg)
...
![图2-11 Skills 渐进式披露机制](../images/ai-agent-book/fig2-11.svg)
...
![图2-12 启用 Skills 后 Agent Trajectory 的完整结构](../images/ai-agent-book/fig2-12.svg){height=55%}

![图2-13 KV Cache 随 Agent Trajectory 增长的演化](../images/ai-agent-book/fig2-13.svg)
...
![图2-14 Agent 状态栏架构](../images/ai-agent-book/fig2-14.svg)
...
![图2-15 Agent 状态栏在 API 消息列表中的插入位置](../images/ai-agent-book/fig2-15.svg)
...
![图2-16 上下文压缩策略对比](../images/ai-agent-book/fig2-16.svg)
...
>
>
> ![图2-17 六种压缩策略的处理流程](../images/ai-agent-book/fig2-17.svg)
>
