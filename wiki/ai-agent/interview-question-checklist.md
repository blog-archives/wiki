...
面向 Go / 后端转 AI Agent 应用开发的面试准备清单，共 16 个模块、120 道题，不含答案。其中 40 道标为 ★ 优先准备题，其余用于第二轮查漏补缺。清单由公开题库、官方工程资料与场景补充综合、筛选、合并和改写而成，不代表逐题核实过公司来源的面试真题。
...
| 模块                  | 题目范围    | 优先题（★）数 |
| ------------------- | ------- | ------- |
| 01 大模型与 API 基础      | 001–008 | 3       |
| 02 Agent 原理与执行范式    | 009–014 | 4       |
| 03 任务拆分与规划          | 015–022 | 3       |
| 04 Prompt 与结构化输出    | 023–028 | 2       |
| 05 工具调用与工具设计        | 029–038 | 3       |
| 06 自纠、校验与循环控制       | 039–044 | 2       |
| 07 上下文工程与记忆         | 045–054 | 3       |
| 08 RAG 与知识检索        | 055–064 | 3       |
| 09 MCP、Skills 与 A2A | 065–070 | 2       |
| 10 多 Agent 与框架选型    | 071–076 | 2       |
| 11 任务状态、持久化与人工介入    | 077–084 | 3       |
| 12 评测、可观测性与迭代       | 085–092 | 3       |
| 13 性能、成本与服务稳定性      | 093–098 | 2       |
| 14 权限、安全与隔离         | 099–104 | 2       |
| 15 Go 工程与编码题        | 105–110 | 2       |
| 16 综合设计、故障排查与项目追问   | 111–120 | 1       |
...
- S1：[Datawhale hello-agents：面试问题总结](https://github.com/datawhalechina/hello-agents/blob/main/Extra-Chapter/Extra01-%E9%9D%A2%E8%AF%95%E9%97%AE%E9%A2%98%E6%80%BB%E7%BB%93.md)
- S2：[AgentGuide：Agent 核心面试题](https://github.com/adongwanai/AgentGuide/blob/main/docs/04-interview/03-agent-questions.md)
- S3：[Anthropic：Building effective agents](https://www.anthropic.com/engineering/building-effective-agents)
- S4：[Anthropic：Writing effective tools for agents](https://www.anthropic.com/engineering/writing-tools-for-agents)
- S5：[Anthropic：Effective context engineering for AI agents](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents)
- S6：[Anthropic：Demystifying evals for AI agents](https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents)
- S7：[OpenAI：Function calling](https://developers.openai.com/api/docs/guides/function-calling)
- S8：[OpenAI：Structured model outputs](https://developers.openai.com/api/docs/guides/structured-outputs)
- S9：[MCP：Architecture overview](https://modelcontextprotocol.io/docs/learn/architecture)
- S10：[Agent Skills：Overview](https://agentskills.io/home)
- S11：[A2A：What is A2A?](https://a2a-protocol.org/latest/topics/what-is-a2a/)
- S12：[LangGraph：Workflows and agents](https://docs.langchain.com/oss/python/langgraph/workflows-agents)
- S13：[LangGraph：Persistence](https://docs.langchain.com/oss/python/langgraph/persistence)
- S14：[CloudWeGo Eino 官方仓库](https://github.com/cloudwego/eino)
- S15：[LangChain：Retrieval](https://docs.langchain.com/oss/python/deepagents/retrieval)
