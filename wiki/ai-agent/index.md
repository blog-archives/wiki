...
**本目录整理 AI Agent 应用开发与工程实践**：原理、工具调用、上下文、任务规划、系统提示词，另含「工具调用」「多 Agent」「中断与恢复」「上下文工程」子专题。

| 文章 | 内容 |
| --- | --- |
| [AI Agent 面试题清单（120 题）](interview-question-checklist.md) | 16 模块 120 题的面试准备清单 |
| [多 Agent（子专题）](multi-agent/index.md) | agent 产品的角色、触发与委派差异，以及 Claude Code 设计与 Eino 框架的多 agent 能力 |
